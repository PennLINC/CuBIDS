...
def test_add_file_collections(tmp_path):
    ...
    f1 = bids_dir / "sub-01" / "func" / "sub-01_task-rest_echo-3_part-phase_bold.json"
    assert f1.exists()
    expected = {
        "EchoTime": 0.45,
        ...
        "FileCollection": [
            "bids::sub-01/func/sub-01_task-rest_echo-1_part-mag_bold.nii.gz",
            "bids::sub-01/func/sub-01_task-rest_echo-1_part-phase_bold.nii.gz",
            "bids::sub-01/func/sub-01_task-rest_echo-2_part-mag_bold.nii.gz",
            "bids::sub-01/func/sub-01_task-rest_echo-2_part-phase_bold.nii.gz",
            "bids::sub-01/func/sub-01_task-rest_echo-3_part-mag_bold.nii.gz",
            "bids::sub-01/func/sub-01_task-rest_echo-3_part-phase_bold.nii.gz",
        ],
        "Units": "arbitrary",
    }
