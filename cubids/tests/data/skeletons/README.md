...
| `skeleton_file_collection_fmap.yml` | B0 and RF field-map file collections | Gradient-echo and PEPOLAR B0 fieldmaps plus all BIDS RF acquisition methods, including separate AFI Test/Retest collections | `cubids/tests/test_file_collections.py` |
